...
*   Core Library:
    ...
    *   Adjust `ExoPlayer` `MediaMetadata` update priority, such that values
        ...
        values.
    *   Move `com.upax.exoplayer2.device.DeviceInfo` to
        `com.upax.exoplayer2.DeviceInfo`.
    *   Move `com.upax.exoplayer2.drm.DecryptionException` to
        `com.upax.exoplayer2.decoder.CryptoException`.
    *   Move `com.upax.exoplayer2.upstream.cache.CachedRegionTracker`
        to `com.upax.exoplayer2.upstream.CachedRegionTracker`.
...
*   Core Library:
    ...
    *   `AdsLoader.AdViewProvider` and `AdsLoader.OverlayInfo` have been renamed
        `com.upax.exoplayer2.ui.AdViewProvider` and
        `com.upax.exoplayer2.ui.AdOverlayInfo` respectively.
    *   `CaptionStyleCompat` has been moved to the
        `com.upax.exoplayer2.ui` package.
...
*   Remove deprecated symbols:
    ...
    *   `SimpleExoPlayer.VideoListener`. Use
        `com.upax.exoplayer2.video.VideoListener` instead.
...
*   Root package name changed to `com.upax.exoplayer2`. The library

 ...
 */
package com.upax.exoplayer2.extractor;

import static com.upax.exoplayer2.util.FileTypes.inferFileTypeFromResponseHeaders;
import static com.upax.exoplayer2.util.FileTypes.inferFileTypeFromUri;
...
import com.upax.exoplayer2.extractor.amr.AmrExtractor;
import com.upax.exoplayer2.extractor.flac.FlacExtractor;
import com.upax.exoplayer2.extractor.flv.FlvExtractor;
import com.upax.exoplayer2.extractor.jpeg.JpegExtractor;
...
import com.upax.exoplayer2.extractor.mp4.Mp4Extractor;
import com.upax.exoplayer2.extractor.ogg.OggExtractor;
import com.upax.exoplayer2.extractor.ts.Ac3Extractor;
import com.upax.exoplayer2.extractor.ts.Ac4Extractor;
import com.upax.exoplayer2.extractor.ts.AdtsExtractor;
import com.upax.exoplayer2.extractor.ts.DefaultTsPayloadReaderFactory;
import com.upax.exoplayer2.extractor.ts.PsExtractor;
import com.upax.exoplayer2.extractor.ts.TsExtractor;
import com.upax.exoplayer2.extractor.ts.TsPayloadReader;
import com.upax.exoplayer2.extractor.wav.WavExtractor;
import com.upax.exoplayer2.util.FileTypes;
import com.upax.exoplayer2.util.TimestampAdjuster;
 ...
 *             com.upax.exoplayer2.ext.flac.FlacExtractor} is used.
...
public final class DefaultExtractorsFactory implements ExtractorsFactory {
   ...
   * by {@code com.upax.exoplayer2.ext.flac.FlacExtractor} instances if the FLAC extension
   * is being used.
   *
      ...
      synchronized (extensionLoaded) {
        ...
        try {
          ...
          boolean isFlacNativeLibraryAvailable =
              Boolean.TRUE.equals(
                  Class.forName("com.upax.exoplayer2.ext.flac.FlacLibrary")
                      .getMethod("isAvailable")
                      .invoke(/* obj= */ null));
          if (isFlacNativeLibraryAvailable) {
            extractorConstructor =
                Class.forName("com.upax.exoplayer2.ext.flac.FlacExtractor")

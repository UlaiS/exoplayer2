 ...
 */
package com.upax.exoplayer2.mediacodec;

import static com.upax.exoplayer2.decoder.DecoderReuseEvaluation.DISCARD_REASON_DRM_SESSION_CHANGED;
import static com.upax.exoplayer2.decoder.DecoderReuseEvaluation.DISCARD_REASON_OPERATING_RATE_CHANGED;
import static com.upax.exoplayer2.decoder.DecoderReuseEvaluation.DISCARD_REASON_REUSE_NOT_IMPLEMENTED;
import static com.upax.exoplayer2.decoder.DecoderReuseEvaluation.DISCARD_REASON_WORKAROUND;
import static com.upax.exoplayer2.decoder.DecoderReuseEvaluation.REUSE_RESULT_NO;
import static com.upax.exoplayer2.decoder.DecoderReuseEvaluation.REUSE_RESULT_YES_WITHOUT_RECONFIGURATION;
import static com.upax.exoplayer2.decoder.DecoderReuseEvaluation.REUSE_RESULT_YES_WITH_FLUSH;
import static com.upax.exoplayer2.decoder.DecoderReuseEvaluation.REUSE_RESULT_YES_WITH_RECONFIGURATION;
import static com.upax.exoplayer2.source.SampleStream.FLAG_OMIT_SAMPLE_DATA;
import static com.upax.exoplayer2.source.SampleStream.FLAG_PEEK;
import static com.upax.exoplayer2.source.SampleStream.FLAG_REQUIRE_FORMAT;
import static com.upax.exoplayer2.util.Assertions.checkNotNull;
import static com.upax.exoplayer2.util.Assertions.checkState;
...
import com.upax.exoplayer2.BaseRenderer;
import com.upax.exoplayer2.C;
import com.upax.exoplayer2.ExoPlaybackException;
import com.upax.exoplayer2.Format;
import com.upax.exoplayer2.FormatHolder;
import com.upax.exoplayer2.PlaybackException;
import com.upax.exoplayer2.decoder.CryptoConfig;
import com.upax.exoplayer2.decoder.DecoderCounters;
import com.upax.exoplayer2.decoder.DecoderInputBuffer;
import com.upax.exoplayer2.decoder.DecoderInputBuffer.InsufficientCapacityException;
import com.upax.exoplayer2.decoder.DecoderReuseEvaluation;
import com.upax.exoplayer2.decoder.DecoderReuseEvaluation.DecoderDiscardReasons;
import com.upax.exoplayer2.drm.DrmSession;
import com.upax.exoplayer2.drm.DrmSession.DrmSessionException;
import com.upax.exoplayer2.drm.FrameworkCryptoConfig;
import com.upax.exoplayer2.mediacodec.MediaCodecUtil.DecoderQueryException;
import com.upax.exoplayer2.source.MediaPeriod;
import com.upax.exoplayer2.source.SampleStream;
import com.upax.exoplayer2.source.SampleStream.ReadDataResult;
import com.upax.exoplayer2.source.SampleStream.ReadFlags;
...
import com.upax.exoplayer2.util.TimedValueQueue;
import com.upax.exoplayer2.util.TraceUtil;
...
public abstract class MediaCodecRenderer extends BaseRenderer {
  ...
  public static class DecoderInitializationException extends Exception {
    ...
    private static String buildCustomDiagnosticInfo(int errorCode) {
      ...
      return "com.upax.exoplayer2.mediacodec.MediaCodecRenderer_"
          + sign
          + Math.abs(errorCode);
    }
  }

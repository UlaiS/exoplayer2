...
import static com.upax.exoplayer2.C.TRACK_TYPE_AUDIO;
import static com.upax.exoplayer2.C.TRACK_TYPE_CAMERA_MOTION;
import static com.upax.exoplayer2.C.TRACK_TYPE_VIDEO;
import static com.upax.exoplayer2.Renderer.MSG_SET_AUDIO_ATTRIBUTES;
import static com.upax.exoplayer2.Renderer.MSG_SET_AUDIO_SESSION_ID;
import static com.upax.exoplayer2.Renderer.MSG_SET_AUX_EFFECT_INFO;
import static com.upax.exoplayer2.Renderer.MSG_SET_CAMERA_MOTION_LISTENER;
import static com.upax.exoplayer2.Renderer.MSG_SET_CHANGE_FRAME_RATE_STRATEGY;
import static com.upax.exoplayer2.Renderer.MSG_SET_SCALING_MODE;
import static com.upax.exoplayer2.Renderer.MSG_SET_SKIP_SILENCE_ENABLED;
import static com.upax.exoplayer2.Renderer.MSG_SET_VIDEO_FRAME_METADATA_LISTENER;
import static com.upax.exoplayer2.Renderer.MSG_SET_VIDEO_OUTPUT;
import static com.upax.exoplayer2.Renderer.MSG_SET_VOLUME;
...
import com.upax.exoplayer2.Renderer.MessageType;
import com.upax.exoplayer2.analytics.AnalyticsCollector;
import com.upax.exoplayer2.analytics.AnalyticsListener;
import com.upax.exoplayer2.audio.AudioAttributes;
import com.upax.exoplayer2.audio.AudioRendererEventListener;
import com.upax.exoplayer2.audio.AuxEffectInfo;
import com.upax.exoplayer2.decoder.DecoderCounters;
import com.upax.exoplayer2.decoder.DecoderReuseEvaluation;
import com.upax.exoplayer2.extractor.ExtractorsFactory;
import com.upax.exoplayer2.metadata.Metadata;
import com.upax.exoplayer2.metadata.MetadataOutput;
import com.upax.exoplayer2.source.DefaultMediaSourceFactory;
import com.upax.exoplayer2.source.MediaSource;
import com.upax.exoplayer2.source.MediaSourceFactory;
import com.upax.exoplayer2.source.ShuffleOrder;
import com.upax.exoplayer2.source.TrackGroupArray;
import com.upax.exoplayer2.text.Cue;
import com.upax.exoplayer2.text.TextOutput;
import com.upax.exoplayer2.trackselection.TrackSelectionArray;
import com.upax.exoplayer2.trackselection.TrackSelectionParameters;
import com.upax.exoplayer2.trackselection.TrackSelector;
import com.upax.exoplayer2.upstream.BandwidthMeter;
...
import com.upax.exoplayer2.util.PriorityTaskManager;
import com.upax.exoplayer2.util.Util;
import com.upax.exoplayer2.video.VideoDecoderOutputBufferRenderer;
import com.upax.exoplayer2.video.VideoFrameMetadataListener;
import com.upax.exoplayer2.video.VideoRendererEventListener;
import com.upax.exoplayer2.video.VideoSize;
import com.upax.exoplayer2.video.spherical.CameraMotionListener;
import com.upax.exoplayer2.video.spherical.SphericalGLSurfaceView;

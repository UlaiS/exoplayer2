...
import com.upax.exoplayer2.audio.AudioCapabilities;
...
import com.upax.exoplayer2.audio.DefaultAudioSink.DefaultAudioProcessorChain;
import com.upax.exoplayer2.audio.MediaCodecAudioRenderer;
import com.upax.exoplayer2.mediacodec.DefaultMediaCodecAdapterFactory;
import com.upax.exoplayer2.mediacodec.MediaCodecSelector;
import com.upax.exoplayer2.metadata.MetadataOutput;
import com.upax.exoplayer2.metadata.MetadataRenderer;
import com.upax.exoplayer2.text.TextOutput;
import com.upax.exoplayer2.text.TextRenderer;
import com.upax.exoplayer2.trackselection.TrackSelector;
import com.upax.exoplayer2.util.Log;
import com.upax.exoplayer2.video.MediaCodecVideoRenderer;
import com.upax.exoplayer2.video.VideoRendererEventListener;
import com.upax.exoplayer2.video.spherical.CameraMotionRenderer;
...
public class DefaultRenderersFactory implements RenderersFactory {
  ...
  /**
   * Enables {@link com.upax.exoplayer2.mediacodec.MediaCodecRenderer} instances to
  ...
  /**
   * Disables {@link com.upax.exoplayer2.mediacodec.MediaCodecRenderer} instances from
  ...
  protected void buildVideoRenderers(
    ...
    try {
      ...
      Class<?> clazz = Class.forName("com.upax.exoplayer2.ext.vp9.LibvpxVideoRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              long.class,
              android.os.Handler.class,
              com.upax.exoplayer2.video.VideoRendererEventListener.class,
              int.class);
      Renderer renderer =
          (Renderer)
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      Class<?> clazz = Class.forName("com.upax.exoplayer2.ext.av1.Libgav1VideoRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              long.class,
              android.os.Handler.class,
  ...
  protected void buildAudioRenderers(
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      Class<?> clazz = Class.forName("com.upax.exoplayer2.ext.opus.LibopusAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              com.upax.exoplayer2.audio.AudioRendererEventListener.class,
              com.upax.exoplayer2.audio.AudioSink.class);
      Renderer renderer =
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      Class<?> clazz = Class.forName("com.upax.exoplayer2.ext.flac.LibflacAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              com.upax.exoplayer2.audio.AudioRendererEventListener.class,
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      Class<?> clazz =
          Class.forName("com.upax.exoplayer2.ext.ffmpeg.FfmpegAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              com.upax.exoplayer2.audio.AudioRendererEventListener.class,

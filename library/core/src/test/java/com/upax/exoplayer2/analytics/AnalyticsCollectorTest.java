 ...
 */
package com.upax.exoplayer2.analytics;

import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_AUDIO_DECODER_INITIALIZED;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_AUDIO_DISABLED;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_AUDIO_ENABLED;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_AUDIO_INPUT_FORMAT_CHANGED;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_AUDIO_POSITION_ADVANCING;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_DOWNSTREAM_FORMAT_CHANGED;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_DRM_KEYS_LOADED;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_DRM_SESSION_ACQUIRED;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_DRM_SESSION_MANAGER_ERROR;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_DRM_SESSION_RELEASED;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_DROPPED_VIDEO_FRAMES;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_IS_LOADING_CHANGED;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_IS_PLAYING_CHANGED;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_LOAD_COMPLETED;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_LOAD_ERROR;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_LOAD_STARTED;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_MEDIA_ITEM_TRANSITION;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_PLAYBACK_PARAMETERS_CHANGED;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_PLAYBACK_STATE_CHANGED;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_PLAYER_ERROR;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_PLAYER_RELEASED;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_PLAY_WHEN_READY_CHANGED;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_POSITION_DISCONTINUITY;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_RENDERED_FIRST_FRAME;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_TIMELINE_CHANGED;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_TRACKS_CHANGED;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_VIDEO_DECODER_INITIALIZED;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_VIDEO_DISABLED;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_VIDEO_ENABLED;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_VIDEO_FRAME_PROCESSING_OFFSET;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_VIDEO_INPUT_FORMAT_CHANGED;
import static com.upax.exoplayer2.analytics.AnalyticsListener.EVENT_VIDEO_SIZE_CHANGED;
...
import com.upax.exoplayer2.ExoPlaybackException;
...
import com.upax.exoplayer2.PlaybackParameters;
import com.upax.exoplayer2.Player;
import com.upax.exoplayer2.Renderer;
import com.upax.exoplayer2.RenderersFactory;
import com.upax.exoplayer2.Timeline;
import com.upax.exoplayer2.Timeline.Window;
import com.upax.exoplayer2.TracksInfo;
import com.upax.exoplayer2.decoder.DecoderCounters;
import com.upax.exoplayer2.drm.DefaultDrmSessionManager;
import com.upax.exoplayer2.drm.DrmInitData;
import com.upax.exoplayer2.drm.DrmSession;
import com.upax.exoplayer2.drm.DrmSessionManager;
import com.upax.exoplayer2.drm.ExoMediaDrm;
import com.upax.exoplayer2.drm.MediaDrmCallback;
import com.upax.exoplayer2.drm.MediaDrmCallbackException;
import com.upax.exoplayer2.metadata.Metadata;
import com.upax.exoplayer2.robolectric.RobolectricUtil;
import com.upax.exoplayer2.robolectric.TestPlayerRunHelper;
import com.upax.exoplayer2.source.ConcatenatingMediaSource;
import com.upax.exoplayer2.source.LoadEventInfo;
import com.upax.exoplayer2.source.MediaLoadData;
...
import com.upax.exoplayer2.testutil.FakeAudioRenderer;
import com.upax.exoplayer2.testutil.FakeClock;
import com.upax.exoplayer2.testutil.FakeExoMediaDrm;
...
import com.upax.exoplayer2.testutil.TestUtil;
import com.upax.exoplayer2.util.Clock;
import com.upax.exoplayer2.util.ConditionVariable;
import com.upax.exoplayer2.util.MimeTypes;
import com.upax.exoplayer2.util.Util;
import com.upax.exoplayer2.video.VideoSize;
